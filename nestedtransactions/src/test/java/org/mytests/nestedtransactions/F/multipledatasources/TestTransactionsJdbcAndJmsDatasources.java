package org.mytests.nestedtransactions.F.multipledatasources;
...
public class TestTransactionsJdbcAndJmsDatasources {
	...
	@Test
	public void addInTwoDataSourcesShouldInsertInBoth() throws JMSException{		
		...
		assertThat(contentService.loadCollection(u.getId()), is(u.getCollection()));
	}
